...
clear
banner() {
  # رنگ فیروزه‌ای پررنگ → پایان با \033[0m
  echo -e "\033[1;36m/**"
  echo -e "* >>==================================================================================<<"
  echo -e "* ||                                                                                  ||"
  echo -e "* ||                                                                                  ||"
  echo -e "* ||   __   __  .___  ___.      ___   ____    __    ____ .___________. __  .__   __.  ||"
  echo -e "* ||  |  | |  | |   \\/   |     /   \\  \\   \\  /  \\  /   / |           ||  | |  \\ |  |  ||"
  echo -e "* ||  |  | |  | |  \\  /  |    /  ^  \\  \\   \\/    \\/   /  \\`---|  |----\\`|  | |   \\|  |  ||"
  echo -e "* ||  |  | |  | |  |\\/|  |   /  /_\\  \\  \\            /       |  |     |  | |  . \\`  |  ||"
  echo -e "* ||  |  | |  | |  |  |  |  /  _____  \\  \\    /\\    /        |  |     |  | |  |\\   |  ||"
  echo -e "* ||  |__| |__| |__|  |__| /__/     \\__\\  \\__/  \\__/         |__|     |__| |__| \\__|  ||"
  echo -e "* ||                                                                                  ||"
  echo -e "* ||                                                                                  ||"
  echo -e "* >>==================================================================================<<"
  echo -e "\n\033[1;34m    →→→→→→→→→→→→→→→→→\033[0m"
