...
# زنجیره بلاک IPهای مشکوک و رنج‌های خاص
...
ABUSE_IPS=(
  ...
  "198.18.0.0/15" "198.51.100.0/24" "203.0.113.0/24" "240.0.0.0/24"
  "224.0.0.0/4" "233.252.0.0/24" "102.0.0.0/8" "185.235.86.0/24"
  "185.235.87.0/24" "114.208.187.0/24" "216.218.185.0/24" "206.191.152.0/24"
  "45.14.174.0/24" "195.137.167.0/24" "103.58.50.1/24" "25.0.0.0/19"
  "25.29.155.0/24" "103.29.38.0/24" "103.49.99.0/24"
)
for ip in "${ABUSE_IPS[@]}"; do
  iptables -A abuse-defender -d "$ip" -j DROP
done
iptables -A FORWARD -j abuse-defender
